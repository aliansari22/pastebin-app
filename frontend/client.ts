 ...
 */
export class Client {
    public readonly paste: paste.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.paste = new paste.ServiceClient(base)
    }
 ...
 */
import { create as api_paste_create_create } from "~backend/paste/create";
import { get as api_paste_get_get } from "~backend/paste/get";
import { list as api_paste_list_list } from "~backend/paste/list";
...
export namespace paste {
    ...
    export class ServiceClient {
         ...
         * Creates a new paste.
         */
        public async create(params: RequestType<typeof api_paste_create_create>): Promise<ResponseType<typeof api_paste_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paste`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paste_create_create>
        }

        /**
         * Retrieves a paste by its ID and increments the view count.
         */
        public async get(params: { id: string }): Promise<ResponseType<typeof api_paste_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paste/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paste_get_get>
        }

        /**
         * Retrieves a list of recent pastes (excluding content for performance).
         */
        public async list(params: RequestType<typeof api_paste_list_list>): Promise<ResponseType<typeof api_paste_list_list>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/paste`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_paste_list_list>
        }
    }
}

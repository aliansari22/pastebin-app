...
```bash
git remote add encore encore://pastebin-app-tgoi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/pastebin-app-tgoi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/pastebin-app-tgoi/settings/integrations/github)
